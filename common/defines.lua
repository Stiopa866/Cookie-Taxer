...
NDiplomacy = {
	...
	HRE_PRINCE_AUTHORITY_THRESHOLD = 0,			-- Threshold below which you lose IA, and above which you gain it
	...
	IMPERIAL_CITY_IA = 0.0,						-- Monthly per imperial free city
...
NCountry = {
	...
	PROVINCE_DISCOVERY_PRESTIGE = 0,				-- Prestige change when first in tech group to discover first province in a region
	PROVINCE_DISCOVERY_YEARS_TECHNOLOGY = 5000,		-- Years until discoveries spread within technology group
	PROVINCE_DISCOVERY_YEARS_RELIGION = 5000,		-- Years until discoveries spread with religion
	...
	MAX_EXTRA_PERSONALITIES = 0,					-- Number of personalities that can be gained except the one you get when turning 15.
...
NMilitary = {
	...
	CAVALRY_SPEED = 2.5, 							-- _MDEF_CAVALRY_SPEED = 10,
	ARTILLERY_SPEED = 0.7, 							-- _MDEF_ARTILLERY_SPEED = 10,

	INFANTRY_COST = 0.0, 							-- _MDEF_INFANTRY_COST = 10,
	CAVALRY_COST = 0.0, 							-- _MDEF_CAVALRY_COST = 10,
	ARTILLERY_COST = 0.0, 							-- _MDEF_ARTILLERY_COST = 10,
	...
	EXPLORATION_TRAVEL_TIME = 1,					-- Multiplier for travel time when exploring
	...
	LEADER_MAX_RANDOM_YEARS = 1,
	LEADER_MAX_RANDOM_DAYS = 1,
	LEADER_WORK_YEARS_DEATH_FACTOR = 9999,					-- Divides how many years he has been working to calculate chance
	LEADER_AGE_DEATH_FACTOR = 9999,					-- Divides age with this to calculate chance
...
NFrontend = {
	CAMERA_LOOKAT_X = 300.0, 						-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 200.0,
	CAMERA_LOOKAT_SETTINGS_X = 300.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 200.0,
	CAMERA_START_X = 300.0,						-- Initial position in main menu
	CAMERA_START_Y = 800,							-- Y is height
	CAMERA_START_Z = 200.0,
	CAMERA_END_X = 300.0,							-- Move to position in main menu
	CAMERA_END_Y = 800.0,
	CAMERA_END_Z = 200.0,
	...
	FRONTEND_POS_X = 300.0,
	FRONTEND_POS_Y = 800.0,
	FRONTEND_POS_Z = 200.0,
	FRONTEND_LOOK_X = 300.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 200.0,

	SETTINGS_POS_X = 300.0,
	SETTINGS_POS_Y = 800.0,
	SETTINGS_POS_Z = 200.0,
	SETTINGS_LOOK_X = 300.0,
	SETTINGS_LOOK_Y = 0.0,
	SETTINGS_LOOK_Z = 200.0,

	MP_OPTIONS_POS_X = 300.0,
	MP_OPTIONS_POS_Y = 800.0,
	MP_OPTIONS_POS_Z = 200.0,
	MP_OPTIONS_LOOK_X = 300.0,
	MP_OPTIONS_LOOK_Y = 0.0,
	MP_OPTIONS_LOOK_Z = 200.0,

	TUTORIAL_POS_X = 300.0,
	TUTORIAL_POS_Y = 800.0,
	TUTORIAL_POS_Z = 200.0,
	TUTORIAL_LOOK_X = 300.0,
	TUTORIAL_LOOK_Y = 21.0,
	TUTORIAL_LOOK_Z = 200.0,

	CONTENT_POS_X = 300.0,
	CONTENT_POS_Y = 800.0,
	CONTENT_POS_Z = 200.0,
	CONTENT_LOOK_X = 300.0,
	CONTENT_LOOK_Y = 0.0,
	CONTENT_LOOK_Z = 200.0,

	CREDITS_POS_X = 300.0,
	CREDITS_POS_Y = 800.0,
	CREDITS_POS_Z = 200.0,
	CREDITS_LOOK_X = 300.0,
	CREDITS_LOOK_Y = 19.0,
	CREDITS_LOOK_Z = 200.0,
},
